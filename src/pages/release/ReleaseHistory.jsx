...
function ReleaseHistory() {
  ...
  return (
    <Layout title="출고내역조회">
      <div className="mb-4">
        <h5 className="fw-semibold mb-1">출고내역조회</h5>
        <small className="text-muted">출고 처리 내역 조회</small>
      </div>
        ...
        <div className="card-body p-3">
          <div className="row g-2">
            ...
            <div className="col-6">
              ...
              <input type="text" className="form-control form-control-sm" placeholder="품목코드" value={itemCode} onChange={e => setItemCode(e.target.value)} />
            </div>
            <div className="col-6">
              <label className="form-label small text-muted mb-1">출고상태</label>
